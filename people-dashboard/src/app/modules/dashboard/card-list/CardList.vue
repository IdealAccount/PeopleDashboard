<template>
    <div class="page-dashboard">
        <v-loader v-if="loading" theme="dark"/>
        <template v-else>
                ...
                >
                    <v-form @submit="fetchUserList">
                        ...
                        <div class="form-group">
                            <v-button title="Upload" type="submit" :loading="filterLoading"/>
                            <v-button title="Reset" btn-style="danger" @click="resetFilter"/>
                            <v-button title="Cancel" btn-style="secondary" style="margin-left: auto"
